...
public class CopyOfUpdateHotelServlet extends GenericServlet {
    /**
	 * 
	 */
	...
	if (hotels.isEmpty()) {
        ...
        for (Entity hotel : hotels) {
        String includedamenitiesstring=(String) hotel.getProperty("includedamenitiesstring");
        pw.println(includedamenitiesstring);
        }
	}

	String hotelName_j;
	String incwasher = "checked";
	...
	try {
    	...
    	otherincludedamenities=  (String) hotel.getProperty("otherincludedamenities");
    	...
    	otherpaidamenities=  (String) hotel.getProperty("otherpaidamenities");
    	...
    	otherinroomamenities=  (String) hotel.getProperty("otherinroomamenities");
    	...
    	othersharedamenities=  (String) hotel.getProperty("othersharedamenities");
    	...
    	mealvegitarian=  (String) hotel.getProperty("mealvegitarian");
    	...
    	otheraccepts=  (String) hotel.getProperty("otheraccepts");
    	...
    	otherspeaks=  (String) hotel.getProperty("otherspeaks");
    	...
    	telephonea = (String) hotel.getProperty("telephonea");
    	telephoneb = (String) hotel.getProperty("telephoneb");
    	telephonec = (String) hotel.getProperty("telephonec");
    	mobilea = (String) hotel.getProperty("mobilea");
    	mobileb = (String) hotel.getProperty("mobileb");
    	mobilec = (String) hotel.getProperty("mobilec");
	...
	pw.println("<B>Ready or not, here I come!!ÇPÇ®ÇÁ</B>");
	pw.println("<div id='bigcontainer'>" +
				...
				"					Yakushima >>" + "" + ">> " +
				"					<textarea name='hotelName' rows='1' cols='12'>" + hotelName + "</textarea>" +
				"					>> (<textarea name='hotelName_j' rows='1' cols='12'>" + hotelName_j + "</textarea>)" +
				"					<input type='submit' value='updatehotelname' />" +
				"				</form>" +
				"			</div>" +
				"			<div id=photobox>" +
				...
				"			        <li class='jcarousel-item-1'><img src=''  alt='' /></li>" +
				"			        <li class='jcarousel-item-2'><img src=''  alt='' /></li>" +
				"			        <li class='jcarousel-item-3'><img src=''  alt='' /></li>" +
				"			        <li class='jcarousel-item-4'><img src=''  alt='' /></li>" +
				"			        <li class='jcarousel-item-4'><img src=''  alt='' /></li>" +
				"			    </ul>" +
				...
				"						<tr>" +
				"						<td><input id=mealvegitarian type='checkbox' name='meals' value='Vegitarian Options'" + mealvegitarian + ">Vegitarian Options" +
				...
				"							<input id=welpet type='checkbox' name='welcoming' value='Pet-Friendly'" + welpet + ">Pet-Friendly<br>" +
				"							<input id=welkid type='checkbox' name='welcoming' value='Kid-Friendly'" + welkid + ">Kid-Friendly" +
				"						<td><input id=welforeigner type='checkbox' name='welcoming' value='Foreigner-Friendly'" + welforeigner + ">Foreigner-Friendly<br> " +
				"							<input id=welcouple type='checkbox' name='welcoming' value='Couple-Friendly'" + welcouple + ">Couple-Friendly<br>" +
				"							<input id=welnoanmals type='checkbox' name='welcoming' value='Keep no animals on premises'" + welnoanimals + ">Keep no animals on premises" +
				"						<tr><td><br><input id=nonsmokingrooms type='radio' name='smoking' value='NonSmoking Rooms Only'" + nonsmokingrooms + ">NonSmoking Rooms Only<br> " +
				"							<input id=smokingrooms type='radio' name='smoking' value='Smoking Rooms Only'" + smokingrooms + ">Smoking Rooms Only<br>" +
				"							<input id=bothrooms type='radio' name='smoking' value='Smoking and Nonsmoking Rooms'" + bothrooms + ">Smoking and Nonsmoking Rooms" +
				"					</table>" +
				...
				"						<option value='Haru'" + Haru + ">Haru</option>" +
				...
				"					</dd><dt>Address:" +
				"						<textarea name='address' rows='3' cols='16'>" + address + "</textarea>" +
				"					<dd>address</dd>" +
				"					</dd><dt>èZèä:" +
				"						<textarea name='address_j' rows='3' cols='16'>" + address_j + "</textarea>" +
				"					<dd>address</dd>" +
				"				<dt>Homepage:" +
