...
public class UpdateHotelAdminServlet1 extends HttpServlet {
	/**
	 * 
	 */
		...
		if (user==null){
			...
			{response.sendRedirect("/updatehotel?hotelKeyString="+hotelKeyString+"&error=NotAdministrator.");}
				...
				try {
					...
					String inclocker =  (String) hotel.getProperty("inclocker");
					...
					String paidlocker =  (String) hotel.getProperty("paidlocker");
					...
					String noanimals=  (String) hotel.getProperty("noanimals");
					...
					String speaksother_j=  Filternulls(hotel, "speaksother_j");
					...
					String Haru = (String) hotel.getProperty("Haru");
					...
					"					<input type='submit' value='Update Map Code'></dd>" +
					"					</form>" +						
					...
					"					<br><input type='Update Included Amenities' value='Update Included Amenities' /> <br>" +
					"				</form>" +
					...
					"					<br>Others (in Japanese):<br>" +
					"					<textarea name=speaksother_j  rows='1' cols='60' maxlength=60 style='resize: none;' >" + speaksother_j + "</textarea>" +
