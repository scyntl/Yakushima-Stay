...
public class DisplayHotelHomeJServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pw.println(	"						</select>" +
				...
				"						<input id='campsite' type='checkbox' name='typeselection' value='Campsite' checked >コテージ<br>" +
				...
				"			<div id=photobox>" +			
				"<br>" +
				"<p>ご希望の週箔は見つかりませんか。観光協会のページで探しましょう！" +
				"<br><a href=http://yakukan.jp/><img src=/images/yta_banner.jpg></a><br>" +
				"			</div>" +
				"			<div id=amenities>" +
