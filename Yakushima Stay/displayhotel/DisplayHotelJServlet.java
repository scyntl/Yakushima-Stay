		...
		if (hotelKeyString==null) 
			...
			try {
				...
				if (!smokingstring.equals("")){
					pw.println("<h3>喫煙について：</h3>" +
							"					" + smokingstring + " <br>");
				}
				if (!closestring.equals("")){
					pw.println("<p><h3>周辺について：</h3>" +
							"					" + closestring + " <br>");
				}
				...
				if (!checkin.equals("")|!checkout.equals("")){
					pw.println("				<br><dt>チェックイン・チェックアウト：" +
							"					<dd>" + checkin + " / " +
							"						" + checkout + "</dd>");
				}
				pw.println("			</dl>" +
