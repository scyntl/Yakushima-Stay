...
public class CopyOfDisplayHotelHomeJServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pw.println(	"						</select>" +
				...
				"			<div id=photobox>" +			
				"<br>" +
				"Looking for accomodations on Yakushima? From campsites to resorts, this pages strives to include them all!" +
				"<p>Still can't find what you're looking for? Try these pages:" +
				"<ul>" +
				"<li>Japanese Information: <br><img src=/images/YTA.jpg><br>" +
				"<li>English Information: <br><img src=/images/YesYakushima.jpg height=80>" +
				"</ul>" +
				"			</div>" +
				"			<div id=amenities>" +
				...
				"If you have questions about a particular accommodation please contact the accommodatino directly. Inquiries about accomodations with the " +
